...
import { PowerSettingsNew, ShoppingBag } from '@mui/icons-material';
    ...
    return (
        <>
            ...
            >
                ...
                <MenuItem component={Link} to="/orders" onClick={handleClose} style={{ textDecoration: 'none', color: 'inherit' }}>
